...
class LibvirtDriver(driver.ComputeDriver):
    ...
    def spawn(self, context, instance, image_meta, injected_files,
        ...
        if 'properties' in image_meta and 'mh_encrypted' in image_meta['properties']:
                # if mh_encrypted is defined then mh_checksum and mh_dek_url should be defined too
                LOG.debug("mhagent hook: spawn encrypted image, original checksum=%s key url=%s", image_meta['properties']['mh_checksum'], image_meta['properties']['mh_dek_url'])
