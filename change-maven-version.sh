...
(cd mtwilson-policyagent-maven-root && $changeVersionCommand)
if [ $? -ne 0 ]; then echo "Failed to change maven version on \"mtwilson-policyagent-maven-root\" folder" >&2; exit 3; fi
ant ready
